...
LABEL Description="This image is used to test WLCG WN workloads via Docker" Vendor="CSCS" Version="0.4.3" URL="https://github.com/miguelgila/docker-wlcg_wn"
